            ...
            <div className="container mx-auto px-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 items-center">
                ...
                <div className="flex justify-center sm:justify-end">
                    <div className="flex flex-col sm:flex-row">
                        <Link to="/login" className="text-white hover:text-gray-200 mb-2 sm:mb-0">Login</Link>
                        <Link to="/register" className="text-white hover:text-gray-200 sm:ml-4 mb-2 sm:mb-0">Register</Link>
                    </div>
                </div>
            </div>
        </footer>
